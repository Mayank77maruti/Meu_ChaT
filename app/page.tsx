          ...
          <div className="text-center space-y-16 animate-fade-in max-w-6xl px-4">
            ...
            <div className="relative space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-4 mt-8">
                <Link
                  href="/login"
                  className="group relative bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white font-medium py-2.5 px-6 sm:py-3 sm:px-8 rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-violet-500/20 flex items-center justify-center space-x-2 sm:space-x-3 w-full max-w-xs sm:max-w-none sm:w-auto"
                >
                ...
                <button className="group relative bg-transparent hover:bg-white/5 text-white font-medium py-2.5 px-6 sm:py-3 sm:px-8 rounded-xl transition-all duration-300 hover:scale-[1.02] border border-white/10 hover:border-white/20 flex items-center justify-center space-x-2 sm:space-x-3 w-full max-w-xs sm:max-w-none sm:w-auto">
