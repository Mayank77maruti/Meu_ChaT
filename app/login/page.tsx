          ...
          if (publicKey) {
            ...
            if (!privateKey) {
              ...
              await fetch('/api/updateUserPublicKey', {
                ...
                body: JSON.stringify({ uid: uid, publicKey: keyPair.publicKey }),
              });
            }
          }
        }
          ...
          <div className="p-8">
            ...
            {resetSent && (
              <div className="mb-4 p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
                <h3 className="text-green-300 font-medium mb-2">Check Your Email</h3>
            ...
            {!resetSent && (
              <form onSubmit={showResetForm ? (e) => { e.preventDefault(); handleResetPassword(); } : handleAction} className="space-y-6">
                <div>
